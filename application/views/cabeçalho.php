   ...
   <img class="" src="<?= base_url('assets/logo/S.K.T.png') ?>" alt="" width="62" height="62">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="<?= base_url('tematica/listar'); ?>">Temáticas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="<?= base_url('publicacao/listar') ?>">Publicações</a>
        </li>
        <li class="nav-item">
